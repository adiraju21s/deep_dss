...
def params_v3(exp_name, convtype='chebyshev5', pooltype='max', nmaps=16,
              activation_func='relu', stat_layer=None, input_channels=1,
              gc_depth=8, nfilters=64,
              const_k=5, var_k=None,
              filters=None, batch_norm_output=False,
...
def model_v3(exp_name, convtype='chebyshev5', pooltype='max', nmaps=16,
             activation_func='relu', stat_layer=None, input_channels=1,
             gc_depth=8, nfilters=64,
             const_k=5, var_k=None,
             filters=None, batch_norm_output=False,
    ...
    return models.deepsphere(**params_v3(exp_name, convtype, pooltype, nmaps,
                                         activation_func, stat_layer, input_channels,
                                         gc_depth, nfilters,
                                         const_k, var_k,
                                         filters, batch_norm_output,
