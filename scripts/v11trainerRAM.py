...
model = model_by_architecture("v11", num_epochs=1, learning_rate=1e-4)
...
model = model_by_architecture("v11", num_epochs=1, learning_rate=8e-5)
...
model = model_by_architecture("v11", num_epochs=1, learning_rate=6e-5)
